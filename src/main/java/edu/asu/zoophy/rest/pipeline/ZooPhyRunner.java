...
public class ZooPhyRunner {
	 ...
	 */
	public void runNewZooPhy(List<String> accessions, ZooPhyDAO dao, LuceneSearcher indexSearcher, List<FastaRecord> records) throws PipelineException {
		try {
			...
			NewSequenceAligner aligner = new NewSequenceAligner(job, dao, indexSearcher);
	 ...
	 * @throws PipelineException
	 */
	public Set<String> testNewZooPhy(List<String> accessions, ZooPhyDAO dao, LuceneSearcher indexSearcher, List<FastaRecord> records) throws PipelineException {
		try {
