...
public class ZoophyDAO {
	 ...
	 * @throws DaoException 
	 */
	public GenBankRecord retreiveLightRecord(String accession) throws GenBankRecordNotFoundException, DaoException {
		try {
	 ...
	 * @throws DaoException 
	 */
	public GenBankRecord retreiveFullRecord(String accession) throws GenBankRecordNotFoundException, DaoException {
		try {
			GenBankRecord record = null;
			String[] param = {accession};
			try {
